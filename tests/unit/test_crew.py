...
class TestCrewAgents:
    def test_create_research_planner(self):
        ...
        agent = create_research_planner(llm="groq/llama-3.3-70b-versatile")
    ...
    def test_create_knowledge_retriever(self):
        ...
        agent = create_knowledge_retriever(llm="groq/llama-3.3-70b-versatile")
    ...
    def test_create_answer_synthesizer(self):
        ...
        agent = create_answer_synthesizer(llm="groq/llama-3.3-70b-versatile")
    ...
    def test_create_quality_evaluator(self):
        ...
        agent = create_quality_evaluator(llm="groq/llama-3.3-70b-versatile")
...
class TestCrewTasks:
    ...
    def test_create_retrieval_task_has_context(self):
        from graphmind.crew.agents import create_knowledge_retriever, create_research_planner
        from graphmind.crew.tasks import create_planning_task, create_retrieval_task

        planner = create_research_planner(llm="groq/llama-3.3-70b-versatile")
        retriever = create_knowledge_retriever(llm="groq/llama-3.3-70b-versatile")
        planning = create_planning_task(planner, "test")
        retrieval = create_retrieval_task(retriever, "test", planning)
